...
const LoginPage = ({ navigation }) => {
  ...
  const handleLogin = async () => {
    ...
    try {
      const res = await axios.post('https://nativebridgeproject.fly.dev/api/auth/login', { email, password });
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.header, { paddingTop: statusBarHeight + 4 }]}>
        <Image source={require('../assets/images/nativebridge_logo2.png')} style={styles.logo} resizeMode="contain" />
